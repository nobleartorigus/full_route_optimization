...
try: 
    ...
    m.save('src/views/routes_algorithm/maps/mapeo_asociados_ags.html')
    ...
    m.save('src/views/routes_algorithm/maps/mapeo_asociados_ags_bounds.html')
...
# url = "https://opensource.api.herokuapp.com:443/weather/06604"
# r.requests.get(url)
# data = r.json()
# res = {
#      "Response": 200,
